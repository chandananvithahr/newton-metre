      ...
      <aside className="w-60 bg-white border-r border-slate-200/80 flex flex-col h-full shrink-0">
        ...
        <div className="px-3 pt-4 space-y-1.5">
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2.5 bg-slate-900 text-white text-[13px] font-medium rounded-full hover:bg-slate-800 transition-all duration-200"
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2.5 border border-slate-200/80 text-slate-600 text-[13px] font-medium rounded-full hover:border-slate-300 hover:text-slate-900 transition-all duration-200"
            style={{ fontFamily: "var(--font-sans)" }}
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-3.5 h-3.5 shrink-0">
