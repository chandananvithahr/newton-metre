        ...
        <div className="space-y-6">
          {[
            ...
            <div key={step.num} className="flex items-start gap-6 group">
              <span className="text-4xl font-extrabold text-primary-200 font-mono leading-none group-hover:text-primary-400 transition-colors">{step.num}</span>
              <div className="flex-1 border-b border-gray-100 pb-6">
                <div className="flex items-center gap-3 mb-1">
                  <span className="text-primary-600" aria-hidden="true">{step.icon}</span>
