# Newton-Metre — Positioning & Messaging
...
A procurement engineer gets a drawing from a supplier with a quote of Rs 2,400 per part. Is that fair?

Today they either:
- Guess based on gut feel and experience
- Call 3 more suppliers and wait 2 weeks for counter-quotes
- Accept the quote and hope for the best

None of these are data-backed. None of them scale. And every overpaid part compounds across hundreds of orders per year.

---

## What Newton-Metre Does (The Work)

1. **Upload a drawing** — Newton-Metre reads it, extracts dimensions, material, and manufacturing processes automatically
2. **Find similar parts** — Newton-Metre searches your past orders and finds "you bought something like this 6 months ago for Rs 1,800"
3. **Break down the cost** — Material: Rs 340. Turning: Rs 280. Milling: Rs 190. Heat treatment: Rs 150. Finishing: Rs 120. Overhead + profit: Rs 320. **Should-cost: Rs 1,400.**
4. **Now you negotiate** — "Your quote is Rs 2,400 but the should-cost is Rs 1,400. Let's talk."
...
A procurement engineer receives a quote from a supplier: Rs 2,400 per part for a turned shaft. He stares at it. Is that fair?

He doesn't know the raw material cost. He doesn't know how long the machining takes. He doesn't know what surface treatment costs. He has no way to challenge the quote line by line. His options: accept the quote and hope for the best, or call 3 more suppliers and wait 2 weeks for counter-quotes.

Multiply this by 200 parts a month. That's how procurement teams burn lakhs on parts they're overpaying for — not because they're bad at their job, but because they simply don't have the cost data.

**What Newton-Metre does (the work):**

1. **Procurement uploads the drawing** — the same drawing the supplier quoted on
2. **Newton-Metre reads it** — extracts dimensions, material, tolerances, and every manufacturing process needed
3. **Calculates every cost line** — Material: Rs 340. Turning: Rs 280 (12 min cycle time). Milling: Rs 190 (8 min). Heat treatment: Rs 150. Chrome plating: Rs 120. Setup + overhead + profit: Rs 320.
4. **Hands the answer** — **Should-cost: Rs 1,400.** The supplier quoted Rs 2,400. That's 70% above what it should cost.
5. **Procurement negotiates** — not with gut feel, but with a line-by-line breakdown the supplier can see and respond to

Newton-Metre is the cost analyst your procurement team doesn't have. It does the number-crunching — material rates, cycle times, finishing costs, overhead — so your team walks into every negotiation already knowing the answer.

**The result:**
- Every quote challenged with data, not gut feel
- Suppliers can't hide margins in opaque pricing
...
**Target part types:** Turned parts, Milled parts, Sheet metal

**Geography:** Indian manufacturing job shop economics (INR pricing, Indian labour/machine rates, Indian material costs)

---

## The Shift

| Before Newton-Metre | With Newton-Metre |
|----------------|---------------|
| "Is this quote fair?" | "The should-cost is Rs 1,400 — your quote is 70% above that" |
| Call 3 suppliers, wait 2 weeks | Upload drawing, get answer in seconds |
| Gut feel negotiation | Data-backed, line-by-line negotiation |
